...
export const projects = sqliteTable(
    ...
    (t) => [
        index("idx_projects_user_type").on(t.userId, t.type, t.archivedAt),
    ],
);
...
export const dayLogs = sqliteTable(
    ...
    (t) => [
        index("idx_day_logs_user_date").on(t.userId, t.date),
    ],
);
...
export const memoryBaseline = sqliteTable(
    ...
    (t) => [
        index("idx_memory_user_computed").on(t.userId, t.computedAt),
    ],
);
