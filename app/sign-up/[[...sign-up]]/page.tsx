...
export default function SignUpPage() {
  return (
    <div className="flex min-h-screen items-center justify-center relative overflow-hidden bg-[#0E0D0B]">
      ...
      <div className="absolute top-[20%] right-[20%] w-96 h-96 bg-[#FF8A3D]/20 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: '5s' }} />
      <div className="absolute bottom-[20%] left-[20%] w-[30rem] h-[30rem] bg-[#FF5722]/10 rounded-full blur-[150px] animate-pulse" style={{ animationDuration: '7s', animationDelay: '2s' }} />
