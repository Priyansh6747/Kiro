      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {Object.entries(bucketTasksByProject).map(([projectId, tasks]) => {
          ...
          return (
            <div
              key={projectId}
              className="border border-border-strong rounded-lg overflow-hidden"
            >
              <div
...
function SwipeableTask({
  ...
  return (
    <div className="relative overflow-hidden border-b border-border-default last:border-0">
      ...
      >
        <div
          className={`flex justify-between items-start mb-1 ${animState === "loading" ? "text-secondary" : "text-primary"}`}
        >
